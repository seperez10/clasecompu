...
double Runge4(double);
double Euler(double , double );
double dt;

    int n=1000;
    double t[1000];
    double rE[1000], xE[1000], yE[1000], vxE[1000], vyE[1000];
    double rL[1000], xL[1000], yL[1000], vxL[1000], vyL[1000];
    double rR[1000], xR[1000], yR[1000], vxR[1000], vyR[1000];///Me toco definir esto como variable global si no la funcion no me funcionaba
...
{
        t[i]=t[i-1]+dt;
        xL[i]=LeapFrog(xL[i-2],vxL[i-1]);
        yL[i]=LeapFrog(yL[i-2],vyL[i-1]);
...
double Runge4(double dt){
    outfileR4.open("datosRunge.dat");
    for (int j=1; j<n; j++){
